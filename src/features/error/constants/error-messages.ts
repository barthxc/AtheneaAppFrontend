...
export const ERROR_MESSAGES: ErrorMessages = {
	...
	CALENDAR: {
		...
		FIND_ALL: {
			...
			500: "Ocurrió un error interno en el servidor. Inténtalo de nuevo más tarde.",
			GENERIC: "Ocurrió un error al buscar los eventos del calendario. Inténtalo de nuevo.",
		},
		FIND_ONE: {
			...
			500: "Ocurrió un error interno en el servidor. Inténtalo de nuevo más tarde.",
			GENERIC: "Ocurrió un error al buscar el evento del calendario. Inténtalo de nuevo.",
		},
		UPDATE: {
			...
			404: "No se pudo encontrar el evento del calendario con el ID proporcionado.",
			500: "Ocurrió un error interno en el servidor. Inténtalo de nuevo más tarde.",
			GENERIC: "Ocurrió un error al actualizar el evento del calendario. Inténtalo de nuevo.",
		},
		REMOVE: {
			...
			404: "No se pudo encontrar el evento del calendario con el ID proporcionado.",
			500: "Ocurrió un error interno en el servidor. Inténtalo de nuevo más tarde.",
			GENERIC: "Ocurrió un error al eliminar el evento del calendario. Inténtalo de nuevo.",
		},
	},
	MEMBERS_INFO: {
		GET_STATISTICS: {
			...
			403: "No tienes permiso para realizar esta acción.",
			500: "Ocurrió un error interno en el servidor. Inténtalo de nuevo más tarde.",
			GENERIC: "Ocurrió un error al obtener las estadísticas. Inténtalo de nuevo.",
		},
	...
	GENERIC: {
		UNKNOW: {
			...
			GENERIC: "GENERIC ERROR: Ocurrió un error desconocido, inténtalo de nuevo más tarde.",
		},
	},
	EMAIL: {
		SEND_EMAIL: {
	...
	DONATION: {
		FIND_ALL: {
			...
			GENERIC: "Hubo un problema al mostrar las donaciones. Por favor, inténtalo de nuevo más tarde.",
		},
		CREATE_PAYMENT_INTENT: {
			...
			GENERIC: "Hubo un problema al procesar tu donación. Por favor, inténtalo de nuevo más tarde.",
		},
		CONFIRM_PAYMENT: {
	...
	COLABORATORS: {
		FIND_ALL: {
			...
			500: "Ocurrió un error interno en el servidor. Inténtalo de nuevo más tarde.",
			GENERIC: "Ocurrió un error al buscar los colaboradores. Inténtalo de nuevo.",
		},
		CREATE: {
	...
	INSTALLATIONS: {
		FIND_ALL: {
			...
			500: "Ocurrió un error interno en el servidor. Inténtalo de nuevo más tarde.",
			GENERIC: "Ocurrió un error al buscar las instalaciones. Inténtalo de nuevo.",
		},
		CREATE: {
	...
	CONTENT: {
		FIND_ALL: {
			400: "Error al buscar todo el contenido.",
		...
		FIND_ONE: {
			400: "Error al buscar el contenido. Verifica el ID del mismo.",
			401: "No tienes autorización para buscar contenido.",
			403: "No tienes permiso para realizar esta acción.",
			404: "No se pudo encontrar el contenido con el ID proporcionado.",
			500: "Ocurrió un error interno en el servidor. Inténtalo de nuevo más tarde.",
			GENERIC: "Ocurrió un error al buscar el contenido. Inténtalo de nuevo.",
		},
		UPDATE: {
		...
		CREATE: {
			400: "Error al crear el contenido. Verifica el ID del mismo.",
			401: "No tienes autorización para crear contenido.",
			403: "No tienes permiso para realizar esta acción.",
			404: "Error al crear el contenido.",
			500: "Ocurrió un error interno en el servidor. Inténtalo de nuevo más tarde.",
			GENERIC: "Ocurrió un error al crear el contenido. Inténtalo de nuevo.",
		},
		REMOVE: {
			400: "Error al eliminar el contenido. Verifica el ID del mismo.",
			401: "No tienes autorización para eliminar contenido.",
			403: "No tienes permiso para realizar esta acción.",
			404: "No se pudo encontrar el contenido con el ID proporcionado.",
			500: "Ocurrió un error interno en el servidor. Inténtalo de nuevo más tarde.",
