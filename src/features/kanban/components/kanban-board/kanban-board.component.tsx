...
import { KanbanService } from "@/features/kanban/services";
import { BoardColumn, BoardContainer, NewSectionDialog, TaskCard } from "@/features/kanban/components";
...
export function KanbanBoard() {
	...
	const announcements: Announcements = {
		...
		onDragOver({ active, over }) {
			if (!KanbanService.hasDraggableData(active) || !KanbanService.hasDraggableData(over)) return;
		...
		onDragEnd({ active, over }) {
			if (!KanbanService.hasDraggableData(active) || !KanbanService.hasDraggableData(over)) {
