...
export const EventsCreate = () => {
	...
	return (
		<>
			<section className="flex justify-end items-start flex-wrap gap-5">
			...
			<UploadImageModal<EventsFormValues>
				...
				isSuccess={isSuccess}
				customElements={{
					fieldsContainer: (children) => <div className="flex flex-col gap-5">{children}</div>,
					additionalFields: (
						<>
							<FormField
							...
							<FormField
								...
								label="Fecha"
								render={{
									renderProp: ({ field }) => <Input disabled={isPending} placeholder="DD/MM/AAAA" {...field} />,
								}}
							/>
