	...
	return (
		<section>
			<div className="flex items-center justify-between space-y-2">
				<h2 className="text-3xl font-bold tracking-tight">Hola, Bienvenido 👋</h2>
			</div>
			<Tabs defaultValue="overview" className="space-y-4">
				<TabsList>
					...
					<Button value="overview">Actualizar</Button>
				</TabsList>
				<TabsContent value="overview" className="space-y-4">
					<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								<CardTitle className="text-sm font-medium">Socios Sin Pagar</CardTitle>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 24 24"
									fill="none"
						...
						<Card>
							<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								<CardTitle className="text-sm font-medium">Socios Por Año</CardTitle>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 24 24"
									fill="none"
					...
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7">
						...
						<Card className="col-span-4 md:col-span-3">
							<CardHeader>
								...
								<CardDescription>Registro de Donaciones de la página web</CardDescription>
							</CardHeader>
				...
				<TabsContent value="contact">
					<p>formulario envio de email para el admin por errores</p>
				</TabsContent>
