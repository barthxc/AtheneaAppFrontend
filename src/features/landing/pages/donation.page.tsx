    ...
    <Section className="mt-20 flex flex-col-reverse xl:flex-row xl:justify-between xl:items-center gap-10 xl:gap-20">
      <div className="flex-1">
        <Paragraph className="text-xl xl:text-2xl text-center">
          Puedes apoyar a nuestra asociación de discapacitados de las siguientes
          maneras:
        </Paragraph>
        <Paragraph className="text-lg xl:text-xl text-center mt-4">
          1. **Transferencia bancaria**: Si prefieres hacer una donación
          mediante transferencia bancaria, utiliza los siguientes datos:
        </Paragraph>
        <Paragraph
        ...
        <Paragraph className="text-sm xl:text-base text-center mt-2">
          Haz clic en el número para copiarlo y utilizarlo en tu transferencia.
