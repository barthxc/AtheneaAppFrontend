...
import { Button, Heading, Paragraph, Progress, Section } from "@/features/landing/components";
			...
			<Section variant="filled" className="flex flex-col gap-10 xl:gap-20">
				...
				<section className="flex justify-center items-start gap-10">
					<article className="max-w-sm text-center">
						...
						<Paragraph>Nuestra asociación prospera gracias a la ayuda y esfuerzo de más de 400 socios.</Paragraph>
					</article>
				</section>
			</Section>
			...
			<Section
				...
				<Accordion type="multiple" className="flex-1 [&_svg]:text-black [&_svg]:w-7 [&_svg]:h-7">
					<AccordionItem value="item-1">
						<AccordionTrigger className="font-medium text-xl xl:text-2xl text-left">¿Qué es Athenea?</AccordionTrigger>
						<AccordionContent>
							<Paragraph>Athenea es una asociación de discapacitados sin ánimo de lucro creada ___</Paragraph>
						</AccordionContent>
					</AccordionItem>
					...
					<AccordionItem value="item-2">
						...
						<AccordionContent>
							<Paragraph>
								Athenea tiene un centro físico que ofrece servicios exlusivos o rebajados para los socios como cimnasio,
								aula de informática, manualidades o actividaeds para niños **** de X a X años
							</Paragraph>
						</AccordionContent>
					</AccordionItem>
					...
					<AccordionItem value="item-4">
						...
						<AccordionContent>
							<Paragraph>
								Puede hacer una donación a nuestra organización benéfica haciendo click en el botón de "Donar ahora" en
								nuestro sitio web.
							</Paragraph>
						</AccordionContent>
					</AccordionItem>
