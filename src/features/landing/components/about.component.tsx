...
import { Button, Heading, Paragraph, Section } from "@/features/landing/components";
		...
		<Section
			...
			<figure className="flex-1">
				<img
					...
					className="w-full h-96 xl:h-[700px] object-cover object-top"
				/>
			</figure>
			<article className="flex flex-col gap-5 xl:gap-10 flex-1">
				...
				<Paragraph className="text-base xl:text-xl text-white">
					Fundada en 2010, Athenea ha sido no solo centro de actividades si no un lugar de convivencia inclusiva donde
					podemos disfrutar de las actividades y eventos que se organizan para sensibilizar a la sociedad las
					discapacidades
				</Paragraph>
