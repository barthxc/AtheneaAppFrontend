					...
					<div className="flex flex-col gap-4">
						...
						<div className="gap-4 md:grid md:grid-cols-3">
							<FormField
								...
								label="Nombre"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Nombre del socio" {...field} />,
								}}
							/>
							<FormField
								formControl={form.control}
								...
								label="Apellidos"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Apellidos del socio" {...field} />,
								}}
							/>
							...
							<FormField
								...
								label="DNI"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="DNI del socio" {...field} />,
								}}
							/>
						</div>
						...
						<div className="gap-4 md:grid md:grid-cols-3">
							<FormField
								...
								label="Teléfono"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Teléfono" {...field} />,
								}}
							/>
							<FormField
								formControl={form.control}
								...
								label="Teléfono 2"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Teléfono 2" {...field} />,
								}}
							/>
							...
							<FormField
								...
								label="Email"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Email" {...field} />,
								}}
							/>
						</div>
						<div className="gap-4 md:grid md:grid-cols-4 max-w-lg">
							<FormField
								...
								label="Fecha de Nac."
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="DD/MM/AAAA" {...field} />,
								}}
							/>
							...
							<FormField
								...
								label="Grado"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="%" {...field} />,
								}}
							/>
								...
								render={{
									renderProp: ({ field }) => (
										<Select
											...
											<FormControl>
												<SelectTrigger>
													<SelectValue defaultValue={MemberStatus.alta} placeholder={MemberStatus.alta.toUpperCase()} />
												</SelectTrigger>
											</FormControl>
											<SelectContent>
					...
					<div className="flex flex-col gap-4">
						...
						<div className="gap-4 md:grid md:grid-cols-4">
							...
							<FormField
								...
								label="Domicilio"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Domicilio" {...field} />,
								}}
							/>
							...
							<FormField
								...
								label="Puerta"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Puerta" {...field} />,
								}}
							/>
							...
							<FormField
								...
								label="Bloque"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Bloque" {...field} />,
								}}
							/>
						</div>
						<div className="gap-4 md:grid md:grid-cols-4 max-w-lg">
							<FormField
								...
								label="Localidad"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Localidad" {...field} />,
								}}
							/>
							...
							<FormField
								...
								label="Provincia"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Provincia" {...field} />,
								}}
							/>
							<FormField
								formControl={form.control}
								...
								label="CP"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="CP" {...field} />,
								}}
							/>
						</div>
					</div>
					...
					<div className="flex flex-col gap-4">
						...
						<div className="gap-4 md:grid md:grid-cols-3">
							<FormField
								...
								label="Nombre"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Nombre" {...field} />,
								}}
							/>
							...
							<FormField
								...
								label="Apellidos"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Apellidos" {...field} />,
								}}
							/>
							<FormField
								formControl={form.control}
								...
								label="DNI"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="DNI" {...field} />,
								}}
							/>
						</div>
						<div className="gap-4 md:grid md:grid-cols-2">
							<FormField
								...
								label="Entidad"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="Entidad" {...field} />,
								}}
							/>
							<FormField
								formControl={form.control}
								...
								label="IBAN"
								render={{
									renderProp: ({ field }) => <Input disabled={loading} placeholder="IBAN" {...field} />,
								}}
							/>
						</div>
					</div>
					...
					<div className="flex flex-col gap-4">
						...
						<div className="gap-4  max-w-7xl">
							<FormField
								...
								render={{
									renderProp: ({ field }) => (
										<Textarea className="min-h-24" disabled={loading} placeholder="Observaciones" {...field} />
									),
								}}
							/>
						</div>
