			...
			<Form {...form}>
					...
					<div className="flex flex-col gap-4">
						...
						<div className="gap-4 md:grid md:grid-cols-3">
							...
							<FormField
								...
								name="lastName"
								label="Apellidos"
								render={({ field }) => <Input disabled={loading} placeholder="Apellidos del socio" {...field} />}
							/>
							...
							<FormField
								...
								label="DNI"
								render={({ field }) => <Input disabled={loading} placeholder="DNI del socio" {...field} />}
							/>
						</div>
						...
						<div className="gap-4 md:grid md:grid-cols-3">
							<FormField
								...
								label="Teléfono"
								render={({ field }) => <Input disabled={loading} placeholder="Teléfono" {...field} />}
							/>
							<FormField
								formControl={form.control}
								name="phoneInfo.phone2"
								label="Teléfono 2"
								render={({ field }) => <Input disabled={loading} placeholder="Teléfono 2" {...field} />}
							/>
							...
							<FormField
								...
								name="email"
								label="Email"
								render={({ field }) => <Input disabled={loading} placeholder="Email" {...field} />}
							/>
						</div>
              ...
              /> */}
								...
								render={({ field }) => (
									<Select
										...
										<FormControl>
											<SelectTrigger>
												<SelectValue
													defaultValue={MemberIsDisabled.no}
													placeholder={MemberIsDisabled.no.toUpperCase()}
												/>
											</SelectTrigger>
										</FormControl>
										<SelectContent>
											{Object.values(MemberIsDisabled).map((isDisabled) => (
												<SelectItem key={isDisabled} value={isDisabled}>
													{isDisabled.toUpperCase()}
												</SelectItem>
											))}
										</SelectContent>
									</Select>
							...
							<FormField
								...
								label="Grado"
								render={({ field }) => <Input disabled={loading} placeholder="%" {...field} />}
							/>
					...
					<div className="flex flex-col gap-4">
						...
						<div className="gap-4 md:grid md:grid-cols-4">
							...
							<FormField
								...
								label="Domicilio"
								render={({ field }) => <Input disabled={loading} placeholder="Domicilio" {...field} />}
							/>
							...
							<FormField
								...
								label="Puerta"
								render={({ field }) => <Input disabled={loading} placeholder="Puerta" {...field} />}
							/>
							...
							<FormField
								...
								label="Bloque"
								render={({ field }) => <Input disabled={loading} placeholder="Bloque" {...field} />}
							/>
						</div>
						<div className="gap-4 md:grid md:grid-cols-4 max-w-lg">
							<FormField
								...
								label="Localidad"
								render={({ field }) => <Input disabled={loading} placeholder="Localidad" {...field} />}
							/>
							...
							<FormField
								...
								label="Provincia"
								render={({ field }) => <Input disabled={loading} placeholder="Provincia" {...field} />}
							/>
							<FormField
								formControl={form.control}
								name="addressInfo.postalCode"
								label="CP"
								render={({ field }) => <Input disabled={loading} placeholder="CP" {...field} />}
							/>
						</div>
					</div>
					<Separator />
					...
					<div className="flex flex-col gap-4">
						...
						<div className="gap-4 md:grid md:grid-cols-3">
							<FormField
								...
								name="bankInfo.name"
								label="Nombre"
								render={({ field }) => <Input disabled={loading} placeholder="Nombre" {...field} />}
							/>
							...
							<FormField
								...
								label="Apellidos"
								render={({ field }) => <Input disabled={loading} placeholder="Apellidos" {...field} />}
							/>
							<FormField
								formControl={form.control}
								name="bankInfo.identificationNumber"
								label="DNI"
								render={({ field }) => <Input disabled={loading} placeholder="DNI" {...field} />}
							/>
						</div>
						<div className="gap-4 md:grid md:grid-cols-2">
							<FormField
								...
								label="Entidad"
								render={({ field }) => <Input disabled={loading} placeholder="Entidad" {...field} />}
							/>
							<FormField
								formControl={form.control}
								name="bankInfo.iban"
								label="IBAN"
								render={({ field }) => <Input disabled={loading} placeholder="IBAN" {...field} />}
							/>
						</div>
					</div>
					<Separator />
					...
					<div className="flex flex-col gap-4">
						...
						<div className="gap-4 md:grid md:grid-cols-4 max-w-lg">
							<FormField
								...
								name="observations"
								label="Observaciones"
								render={({ field }) => <Input disabled={loading} placeholder="Observaciones" {...field} />}
							/>
						</div>
					</div>
