...
import { Button, buttonVariants, Heading, Input, Separator, useToast } from "@/features/core/components/ui";
...
export function MembersExituPage() {
	...
	const { filters, currentPage, handleFiltersChange, handlePageChange, handleSearch } = useMemberTableMethods();

	const { members, totalPages, hasNextPage, hasPreviousPage, isError, isLoading, errorMessage, isFetching } =
	...
	return (
		<section>
			<div className="flex items-start justify-between">
				<Heading title="Socios en exitus" description="Consulta la lista de socios dados con exitus" />
