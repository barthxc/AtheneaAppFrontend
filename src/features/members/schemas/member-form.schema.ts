	...
	.object({
		...
		addressInfo: z.object({
			streetType: z
				...
				.optional(),
			streetName: z.union([
				z.string().min(3, "El nombre de la calle debe tener al menos 3 caracteres").nullable().optional(),
				z.literal(""),
			]),
			...
			province: z.union([
				z.string().min(3, "El nombre de la provincia debe tener al menos 3 caracteres").nullable().optional(),
				z.literal(""),
			]),
			postalCode: z.union([
		...
		bankInfo: z.object({
			...
			name: z.union([
				z.string().min(3, "El nombre debe tener al menos 3 caracteres").nullable().optional(),
				z.literal(""),
			]),
			lastName: z.union([z.string().min(4, "Ingresa al menos 4 caracteres").nullable().optional(), z.literal("")]),
			identificationNumber: z.union([
				z
					.string()
					.min(8, "El DNI debe tener al menos 8 caracteres")
