...
export const memberFormSchema = z
  .object({
    ...
    email: z.union([
      z.string().email("Ingresa un correo válido").nullable().optional(),
      z.literal(""),
    ]),
    birthDate: z
      .string()
    ...
    addressInfo: z.object({
      ...
      streetName: z.union([
        z
          .string()
          .min(3, "El nombre de la calle debe tener al menos 3 carácteres")
          .nullable()
          .optional(),
        z.literal(""),
      ]),
      door: z.union([
        z.string().min(1, "Campo obligatorio").nullable().optional(),
        z.literal(""),
      ]),
      block: z.union([
        z.string().min(1, "Campo obligatorio").nullable().optional(),
      ...
      province: z.union([
        z
          .string()
          .min(3, "El nombre de la provincia debe tener al menos 3 carácteres")
          .nullable()
          .optional(),
        z.literal(""),
      ]),
    ...
    bankInfo: z.object({
      ...
      lastName: z.union([
        z
          .string()
          .min(4, "Ingresa al menos 4 carácteres")
          .nullable()
          .optional(),
        z.literal(""),
      ]),
